# Paper trading digest -- 2026-08-25

## Today's activity
  (no exits or entries)

## Open positions
  DIS: 60 sh @ $102.54 (breakout), stop $97.68, held 13/15 days
  XOM: 37 sh @ $166.07 (breakout), stop $158.76, held 4/15 days
  PFE: 225 sh @ $28.00 (breakout), stop $26.82, held 3/15 days

## Watching for tomorrow's open
  (no new signals today)

## Running P&L since paper trading started
  Strategy:  $25388.74 (+1.55%)
